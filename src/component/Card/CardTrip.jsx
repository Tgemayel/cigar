...
const CardTrip = (props) => {
    return (
        <Fragment>
            <NavLink to="/detail" className="wrapper__card-trip color__black d-inline-block w-100">
                ...
                <div className="desc">
                    <div className="d-flex align-items-start justify-content-between">
                        <div>
                            ...
                            <p className='mb-0 normal font__size--16 text__16-1024 color__gray-3 mb-0'>{props.data.location}</p>
                        </div>
                    ...
                    <div className="d-flex align-items-center justify-content-between">
                        ...
                        <span className='medium font__size--24 text__24-1024'>${props.data.price}<span className='medium font__size--12'>/Night</span></span>
                    </div>
                </div>
            </NavLink>
        </Fragment>
